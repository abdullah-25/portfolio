  ...
  return (
    <>
      <div className="container">
        <div className="container-projects">Projects</div>
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p>
            ...
            'Introduction to Programming using Python.' This course introduced
            me to the world of coding and ignited my passion for technology.
            Python's simplicity and versatility captivated me, setting the
        ...
        >
          ...
          <p>
            ...
            applications, such as Apple's 'Memoji' feature. This project marked
            my introduction to the exciting world of AI and its potential to
            reshape digital expression.
          </p>
        ...
        >
          ...
          <p>
            ...
            principles. This class allowed me to check for beam failure values
            and serviceability limits. I used Matplotlib to create informative
        ...
        >
          ...
          <p>
            ...
            creation of my first React app. The project was not only a debut
            into the world of React but also a testament to the efficiency of my
            work, as I managed to complete it within the remarkable timeframe of
            under 10 hours. The project presented an opportunity to explore the
            powerful capabilities of React, a popular JavaScript library for
            ...
            project's objectives. This achievement underscored the rapid
            learning curve and adaptability that comes with web development and
            React in particular.
            <br />
            <br />
        ...
        >
          ...
          <p>
            Participated in Google's 24-hour hackathon, my 3rd hackathon, where
            I used React, Node.js, and Express to redesign a responsive Gmail
            app. I inntegrated AI features and focused on user-friendliness
            based on feedback. This experience emphasized collaboration and the
            integration of cutting-edge technology into real-world applications.
          </p>
        ...
        >
          ...
          <p>
            ...
            data in the form of interactive charts. It helps users stay
            motivated and monitor their fitness journey effectively. Built using
            React, NodeJS, Firebase and MySQL.
          </p>
          <img
            style={{
              marginTop: "1.5rem",
